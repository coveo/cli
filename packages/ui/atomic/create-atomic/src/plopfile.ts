...
export default function (plop: NodePlopAPI) {
  ...
  async function createImpersonateApiKey(
    name: string,
  ...
  plop.setGenerator('@coveo/atomic', {
    ...
    actions: function () {
      return [
        ...
        async function generateImpersonateApiKey(data) {
          const answers = data as PlopData;
          const platformClient = initPlatformClient(answers);
          const apiKeyModel = await createImpersonateApiKey(
            answers['project'],
            platformClient
          );
          answers['api-key'] = apiKeyModel.value!;
          return 'An impersonate Api Key has been created for this project';
        },
        {
          type: 'add',
