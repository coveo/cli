...
@coveo/cli/1.16.0 linux-x64 node-v16.10.0
$ coveo --help [COMMAND]
USAGE
  $ coveo COMMAND
...
...
_See code: [src/commands/auth/login.ts](https://github.com/coveo/cli/blob/v1.16.0/packages/cli/src/commands/auth/login.ts)_
...
_See code: [src/commands/auth/token.ts](https://github.com/coveo/cli/blob/v1.16.0/packages/cli/src/commands/auth/token.ts)_
...
_See code: [src/commands/config/get.ts](https://github.com/coveo/cli/blob/v1.16.0/packages/cli/src/commands/config/get.ts)_
...
_See code: [src/commands/config/set.ts](https://github.com/coveo/cli/blob/v1.16.0/packages/cli/src/commands/config/set.ts)_
...
_See code: [src/commands/org/list.ts](https://github.com/coveo/cli/blob/v1.16.0/packages/cli/src/commands/org/list.ts)_
...
_See code: [src/commands/org/search/dump.ts](https://github.com/coveo/cli/blob/v1.16.0/packages/cli/src/commands/org/search/dump.ts)_
...
_See code: [src/commands/source/push/add.ts](https://github.com/coveo/cli/blob/v1.16.0/packages/cli/src/commands/source/push/add.ts)_
...
_See code: [src/commands/source/push/delete.ts](https://github.com/coveo/cli/blob/v1.16.0/packages/cli/src/commands/source/push/delete.ts)_
...
_See code: [src/commands/source/push/list.ts](https://github.com/coveo/cli/blob/v1.16.0/packages/cli/src/commands/source/push/list.ts)_
...
_See code: [src/commands/source/push/new.ts](https://github.com/coveo/cli/blob/v1.16.0/packages/cli/src/commands/source/push/new.ts)_
...
OPTIONS
  ...
  -v, --version=version  [default: 1.16.0] The version of @coveo/angular to use.
```

_See code: [src/commands/ui/create/angular.ts](https://github.com/coveo/cli/blob/v1.16.0/packages/cli/src/commands/ui/create/angular.ts)_
...
OPTIONS
  -v, --version=version  [default: 1.16.0] Version of @coveo/cra-template to use.
...
_See code: [src/commands/ui/create/react.ts](https://github.com/coveo/cli/blob/v1.16.0/packages/cli/src/commands/ui/create/react.ts)_
...
OPTIONS
  ...
  -v, --version=version  [default: 1.16.0] The version of @coveo/vue-cli-plugin-typescript to use.
...
_See code: [src/commands/ui/create/vue.ts](https://github.com/coveo/cli/blob/v1.16.0/packages/cli/src/commands/ui/create/vue.ts)_
