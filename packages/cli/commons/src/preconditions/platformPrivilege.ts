...
See https://docs.coveo.com/en/1707/#search-pages-domain.`
      : 'You are not authorized to create an API Key with the 'Create search pages' privilege. Please contact an administrator of your Coveo organization and ask for that privilege.  See https://docs.coveo.com/en/1707/#search-pages-domain.',
};
