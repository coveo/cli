...
_See code: [src/commands/atomic/component.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/atomic/component.ts)_
...
_See code: [src/commands/atomic/init.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/atomic/init.ts)_
...
_See code: [src/commands/auth/login.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/auth/login.ts)_
...
_See code: [src/commands/auth/token.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/auth/token.ts)_
...
_See code: [src/commands/config/get.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/config/get.ts)_
...
_See code: [src/commands/config/set.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/config/set.ts)_
...
_See code: [src/commands/org/create.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/org/create.ts)_
...
_See code: [src/commands/org/list.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/org/list.ts)_
...
_See code: [src/commands/org/resources/list.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/org/resources/list.ts)_
...
_See code: [src/commands/org/resources/model/create.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/org/resources/model/create.ts)_
...
_See code: [src/commands/org/resources/monitor.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/org/resources/monitor.ts)_
...
_See code: [src/commands/org/resources/preview.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/org/resources/preview.ts)_
...
USAGE
  $ coveo org:resources:pull [-w <value>] [-o <value>] [-g] [-f] [-m <value> | [-s <value> | -r
    EXTENSION|FEATURED_RESULT|FIELD|FILTER|INSIGHT_PANEL_CONFIGURATION|INSIGHT_PANEL_INTERFACE|MAPPING|QUERY_PARAMETER|Q
    UERY_PIPELINE|QUERY_PIPELINE_CONDITION|RANKING_EXPRESSION|RANKING_WEIGHT|SEARCH_PAGE|SECURITY_PROVIDER|SOURCE|STOP_W
    ORD|SUBSCRIPTION|THESAURUS|TRIGGER] |  | ]
...
FLAGS
  ...
  -o, --organization=targetorganizationg7dg3gd  The unique identifier of the organization from which to pull the
                                                ...
                                                be used.
  -r, --resourceTypes=type1 type2...            [default: EXTENSION,FEATURED_RESULT,FIELD,FILTER,INSIGHT_PANEL_CONFIGURA
                                                TION,INSIGHT_PANEL_INTERFACE,MAPPING,QUERY_PARAMETER,QUERY_PIPELINE,QUER
                                                Y_PIPELINE_CONDITION,RANKING_EXPRESSION,RANKING_WEIGHT,SEARCH_PAGE,SECUR
                                                ITY_PROVIDER,SOURCE,STOP_WORD,SUBSCRIPTION,THESAURUS,TRIGGER] The
                                                resources types to pull from the organization.
  -s, --snapshotId=<value>                      The unique identifier of the snapshot to pull. If not specified, a new
                                                snapshot will be created. You can list available snapshot in your
                                                organization with org:resources:list
  -w, --wait=seconds                            [default: 60] The maximum number of seconds to wait before the commands
...
_See code: [src/commands/org/resources/pull.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/org/resources/pull.ts)_
...
_See code: [src/commands/org/resources/push.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/org/resources/push.ts)_
...
_See code: [src/commands/org/search/dump.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/org/search/dump.ts)_
...
_See code: [@coveo/cli-plugin-source](https://github.com/coveo/cli/blob/@coveo/cli@2.3.4/packages/cli/source/src/commands/source/catalog/add.ts)_
...
_See code: [@coveo/cli-plugin-source](https://github.com/coveo/cli/blob/@coveo/cli@2.3.4/packages/cli/source/src/commands/source/catalog/new.ts)_
...
_See code: [@coveo/cli-plugin-source](https://github.com/coveo/cli/blob/@coveo/cli@2.3.4/packages/cli/source/src/commands/source/list.ts)_
...
_See code: [@coveo/cli-plugin-source](https://github.com/coveo/cli/blob/@coveo/cli@2.3.4/packages/cli/source/src/commands/source/push/add.ts)_
...
_See code: [@coveo/cli-plugin-source](https://github.com/coveo/cli/blob/@coveo/cli@2.3.4/packages/cli/source/src/commands/source/push/delete.ts)_
...
_See code: [@coveo/cli-plugin-source](https://github.com/coveo/cli/blob/@coveo/cli@2.3.4/packages/cli/source/src/commands/source/push/new.ts)_
...
FLAGS
  ...
  -v, --version=<value>  [default: 1.36.10] The version of @coveo/angular to use.
...
_See code: [src/commands/ui/create/angular.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/ui/create/angular.ts)_
...
FLAGS
  ...
  -v, --version=<value>                              [default: 1.40.3] The version of @coveo/create-atomic to use.
...
_See code: [src/commands/ui/create/atomic.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/ui/create/atomic.ts)_
...
FLAGS
  -v, --version=<value>  [default: 1.38.19] Version of @coveo/cra-template to use.
...
_See code: [src/commands/ui/create/react.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/ui/create/react.ts)_
...
FLAGS
  -v, --version=<value>  [default: 1.4.1] The version of @coveo/create-headless-vue to use.
...
_See code: [src/commands/ui/create/vue.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/ui/create/vue.ts)_
...
_See code: [src/commands/ui/deploy.ts](https://github.com/coveo/cli/blob/@coveo/cli@3.2.7/packages/cli/core/src/commands/ui/deploy.ts)_
