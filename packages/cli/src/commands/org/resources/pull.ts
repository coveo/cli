...
export default class Pull extends Command {
  ...
  public static flags = {
    ...
    model: flags.build<SnapshotPullModel>({
      ...
      description:
        'The path to a snapshot JSON model. This flag is useful when you want to include spcific resource items to your snapshot (e.g. a subset of sources). Use the "org:resources:model:create" command to create a new Snapshot Pull Model',
    }),
  };
