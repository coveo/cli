...
We collect information related to the use of the CLI and plug-ins, such as which commands and parameters were run, and performance and error data.\n
We use these data to improve the Coveo platform by looking at trends in command executions.\n
We also research error data to improve the CLI.\n
